    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleSkillMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoleSkillMappings_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleSkillMappings_Skills_SkillId",
                        column: x => x.SkillId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeSkillMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeSkillMappings_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeSkillMappings_Skills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSkillMappings_EmployeeId",
                table: "EmployeeSkillMappings",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSkillMappings_SkillId",
                table: "EmployeeSkillMappings",
                column: "SkillId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleSkillMappings_RoleId",
                table: "RoleSkillMappings",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleSkillMappings_SkillId",
                table: "RoleSkillMappings",
                column: "SkillId");
